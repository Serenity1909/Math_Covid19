...
exist = False
try:
    test = open("1 passe_P4.json", 'r').read()
    if test != "":
        exist = True
    else:
        exist = False
...
if exist == False:
    ...
    file = open("1 passe_P4.json", "w", encoding='utf8')
    file.write("{\n")
...
file = open("1 passe_P4.json", "r", encoding='utf8').read()
file = json.loads(file)
print("► Fichier '1 passe_P4.json' chargé")
...
sortie = open("result_MTX_P4.json", "w", encoding='utf8')
sortie.write("{\n")
