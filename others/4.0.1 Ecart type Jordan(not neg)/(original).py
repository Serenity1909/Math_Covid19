...
file = open("1 passe.json", "w", encoding='utf8')
file.write("{\n")
...
file = open("1 passe.json", "r", encoding='utf8').read()
file = json.loads(file)
print("► Fichier '1 passe.json' chargé")
...
sortie = open("result_MTX.json", "w", encoding='utf8')
sortie.write("{\n")
